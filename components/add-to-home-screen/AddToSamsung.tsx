...
export default function AddToSamsung(props: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[80%] z-50 pb-12 px-4">
      <div className="relative p-4 h-full rounded-xl flex flex-col justify-around items-center text-center">
        ...
        <div className="flex flex-col gap-2 items-center text-lg w-full px-4">
          ...
          <div className="text-zinc-800 flex flex-col gap-2 items-center p-4 rounded-lg">
        ...
        <div className="flex flex-col gap-2 items-center text-lg w-full px-4">
          <p>Then select:</p>
          <div className="text-zinc-800 flex flex-col gap-2 items-center py-2 px-4 rounded-lg">
            <p>Home screen</p>
          </div>
        </div>
