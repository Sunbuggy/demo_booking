...
export default function AddToIosSafari(props: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[60%] z-50 pb-12 px-4 ">
      <div className="relative p-4 h-full rounded-xl flex flex-col justify-around bg-slate-700/35 items-center text-center">
