...
const TruckPretripHistory = ({
  ...
  const [truckPretripHistory, setTruckPretripHistory] = React.useState<
    Database['public']['Tables']['vehicle_pretrip_truck']['Row'][]
  >([]);
  ...
  return (
    <>
      {truckPretripHistory.map((pretripHistory, index) => {
...
export default TruckPretripHistory;
