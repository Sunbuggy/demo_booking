...
const BuggyPretripHistory = ({
  ...
  const [buggyPretripHistory, setBuggyPretripHistory] = React.useState<
  ...
  return (
    <>
      {buggyPretripHistory.map((pretripHistory, index) => {
...
export default BuggyPretripHistory;
