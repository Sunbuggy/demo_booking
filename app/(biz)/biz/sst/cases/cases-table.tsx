...
const CasesTable = ({
  ...
  const renderLocationLink = (sst: VehicleLocation) => (
    <Link
      href={`https://www.google.com/maps/search/?api=1&query=${sst.latitude},${sst.longitude}`}
      target="_blank"
  ...
  const renderMobileCard = (sst: VehicleLocation) => (
    ...
    >
      ...
      <CardContent>
        <p>
          <strong>Location:</strong> {renderLocationLink(sst)}
        </p>
        <p>
